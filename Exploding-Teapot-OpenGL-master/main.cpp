...
void myKeys(unsigned char key, int x, int y)
{
    ...
    switch(key)  
    {
		...
		case 'b':
			shape->setBoom(true);
			printf("Boom Mode Enabled.\n");
			break;
		case 'B':
			shape->setBoom(false);
			printf("Boom Mode Disabled.\n");
			break;
        default: break;
    }
...
void MouseButton(int button, int state, int x, int y)
{
  ...
  //cout<<"MouseButton: "<<button<<", "<<state<<", "<<x<<", "<<y<<"\n";
...
void MouseMotion(int x, int y)
{
    ...
    if(pan_win1){   // change translation
		...
		//cout<<"new Tx: "<<shape->getTx()<<", new Ty: "<<shape->getTy()<<"\n";
        ...
        switch(rotateAxis_win1){
            case 'x':
				...
				//cout<<"new Rx: "<<shape->getRx()<<"\n";
                break;
            case 'y':
                shape->setRy(shape->getRy()+dx/5);
				//cout<<"new Ry: "<<shape->getRy()<<"\n";
                break;
            case 'z':
                shape->setRz(shape->getRz()+dx/5);
				//cout<<"new Rz: "<<shape->getRz()<<"\n";
                break;
            default:
                break;
        }
